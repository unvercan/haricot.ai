...
public class Constants {
    ...
    // request
    public static final int REQUEST_READ_CAMERA_AND_STORAGE = 100;
    ...
    // threshold
    public static final float IMAGE_CLASSIFIER_THRESHOLD = 0.2f;
    public static final float NATURAL_LANGUAGE_UNDERSTANDING_THRESHOLD = 0.3f;
